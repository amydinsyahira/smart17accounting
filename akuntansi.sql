...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2016 at 01:57 PM
...
(1, 'admin', 'Yogyakarta', 'dd79aa3aa1673a859i0e34305abe1cf32800nma434a', 'admin@yahoo.com', 'superadmin', 'dceg9ucn04sqg60ifok1n587s6'),
...
--
-- Table structure for table `rek_bandung`
--

CREATE TABLE `rek_bandung` (
  `id_rek_bdg` int(11) NOT NULL,
...
--
-- Dumping data for table `rek_bandung`
--
...
--
-- Table structure for table `rek_jayapura`
--

CREATE TABLE `rek_jayapura` (
  `id_rek_djj` int(11) NOT NULL,
...
--
-- Dumping data for table `rek_jayapura`
--
...
--
-- Table structure for table `rek_jogja`
--

CREATE TABLE `rek_jogja` (
  `id_rek_jog` int(11) NOT NULL,
...
--
-- Dumping data for table `rek_jogja`
--
...
--
-- Table structure for table `rek_tiket`
--

CREATE TABLE `rek_tiket` (
  `id_rek_tkt` int(11) NOT NULL,
  `no_rek_tkt` varchar(2) NOT NULL,
  `rek_tkt` varchar(30) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rek_tiket`
--
...
--
-- Table structure for table `rek_tour`
--

CREATE TABLE `rek_tour` (
  `id_rek_tur` int(11) NOT NULL,
  `no_rek_tur` varchar(2) NOT NULL,
  `rek_tur` varchar(30) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rek_tour`
--
...
--
-- Table structure for table `trans_bandung`
--

CREATE TABLE `trans_bandung` (
...
--
-- Table structure for table `trans_jayapura`
--

CREATE TABLE `trans_jayapura` (
  `id_djj` int(11) NOT NULL,
...
--
-- Table structure for table `trans_jogja`
--

CREATE TABLE `trans_jogja` (
...
--
-- Dumping data for table `trans_jogja`
--
...
--
-- Table structure for table `trans_tiket`
--

CREATE TABLE `trans_tiket` (
...
--
-- Dumping data for table `trans_tiket`
--
...
--
-- Table structure for table `trans_tour`
--

CREATE TABLE `trans_tour` (
...
--
-- Dumping data for table `trans_tour`
--
...
--
-- Indexes for table `rek_bandung`
--
ALTER TABLE `rek_bandung`
  ADD PRIMARY KEY (`id_rek_bdg`),
  ADD UNIQUE KEY `no_rek_jog` (`no_rek_bdg`,`rek_bdg`);

--
-- Indexes for table `rek_jayapura`
--
ALTER TABLE `rek_jayapura`
  ADD PRIMARY KEY (`id_rek_djj`),
  ADD UNIQUE KEY `no_rek_jog` (`no_rek_djj`,`rek_djj`);

--
-- Indexes for table `rek_jogja`
--
ALTER TABLE `rek_jogja`
  ADD PRIMARY KEY (`id_rek_jog`),
  ADD UNIQUE KEY `no_rek_jog` (`no_rek_jog`,`rek_jog`);

--
-- Indexes for table `rek_tiket`
--
ALTER TABLE `rek_tiket`
  ADD PRIMARY KEY (`id_rek_tkt`),
  ADD UNIQUE KEY `no_rek_jog` (`no_rek_tkt`,`rek_tkt`);

--
-- Indexes for table `rek_tour`
--
ALTER TABLE `rek_tour`
  ADD PRIMARY KEY (`id_rek_tur`),
  ADD UNIQUE KEY `no_rek_jog` (`no_rek_tur`,`rek_tur`);

--
-- Indexes for table `trans_bandung`
--
ALTER TABLE `trans_bandung`
  ADD PRIMARY KEY (`id_bdg`),
  ADD UNIQUE KEY `notrans_jog` (`notrans_bdg`),
  ADD UNIQUE KEY `code_tur` (`code_tur`),
  ADD UNIQUE KEY `code_tkt` (`code_tkt`);

--
-- Indexes for table `trans_jayapura`
--
ALTER TABLE `trans_jayapura`
  ADD PRIMARY KEY (`id_djj`),
  ADD UNIQUE KEY `notrans_jog` (`notrans_djj`),
  ADD UNIQUE KEY `code_tkt` (`code_tkt`),
  ADD UNIQUE KEY `code_tur` (`code_tur`);

--
-- Indexes for table `trans_jogja`
--
ALTER TABLE `trans_jogja`
  ADD PRIMARY KEY (`id_jog`),
  ADD UNIQUE KEY `notrans_jog` (`notrans_jog`);

--
-- Indexes for table `trans_tiket`
--
ALTER TABLE `trans_tiket`
  ADD PRIMARY KEY (`id_tkt`),
  ADD UNIQUE KEY `notrans_jog` (`notrans_tkt`),
  ADD UNIQUE KEY `nocode` (`code_tkt`);

--
-- Indexes for table `trans_tour`
--
ALTER TABLE `trans_tour`
  ADD PRIMARY KEY (`id_tur`),
  ADD UNIQUE KEY `notrans_jog` (`notrans_tur`),
  ADD UNIQUE KEY `code_tur` (`code_tur`);
...
--
ALTER TABLE `admins`
  MODIFY `adminid` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `rek_bandung`
--
ALTER TABLE `rek_bandung`
  MODIFY `id_rek_bdg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT for table `rek_jayapura`
--
ALTER TABLE `rek_jayapura`
  MODIFY `id_rek_djj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
-- AUTO_INCREMENT for table `rek_jogja`
--
ALTER TABLE `rek_jogja`
  MODIFY `id_rek_jog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT for table `rek_tiket`
--
ALTER TABLE `rek_tiket`
  MODIFY `id_rek_tkt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `rek_tour`
--
ALTER TABLE `rek_tour`
  MODIFY `id_rek_tur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `trans_bandung`
--
ALTER TABLE `trans_bandung`
  MODIFY `id_bdg` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `trans_jayapura`
--
ALTER TABLE `trans_jayapura`
  MODIFY `id_djj` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `trans_jogja`
--
ALTER TABLE `trans_jogja`
  MODIFY `id_jog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `trans_tiket`
--
ALTER TABLE `trans_tiket`
  MODIFY `id_tkt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `trans_tour`
--
ALTER TABLE `trans_tour`
  MODIFY `id_tur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
