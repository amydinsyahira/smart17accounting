...
class DHTML_Calendar {
    ...
    function DHTML_Calendar($calendar_lib_path = '/calendar/',
                            ...
                            $stripped          = true) {
        if ($stripped) {
            $this->calendar_file = 'js/calendar_stripped.js';
            $this->calendar_setup_file = 'js/calendar-setup_stripped.js';
        } else {
            $this->calendar_file = 'js/calendar.js';
            $this->calendar_setup_file = 'js/calendar-setup.js';
        }
